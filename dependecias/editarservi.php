...
<body>
    ...
    <div class="contentcontainer">
        ...
        <div class="text-box">
            <h2 style="color: black;">Modificación empleados Servicios públicos</h2>
        </div>
        </div> 
       <div class="sy">
      ...
      $isv=$_GET['is'];
       $select="SELECT * from servicios_publicos where no_empleado='$isv'";
         ?>
   ...
   if (isset($_POST['editar'])) {
    ...
    $quer = "UPDATE servicios_publicos SET 
    ...
    if ($conexion->query($quer)) {
        echo "<script>alert('El empleado [$no_empleado] se editó correctamente'); location.href='servicios_publicos.php';</script>";
    } else {
        echo "<script>alert('El empleado [$no_empleado] no se editó correctamente'); location.href='servicios_publicos.php';</script>" . $conexion->error;
    }
}
