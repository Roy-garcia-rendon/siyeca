        ...
        <main id="principal">
            <header>
                <div class="Menu container">
                 ...
                 <li><a href="obras.php">Obras públicas</a></li>
                 <li><a href="dependecias/servicios_publicos.php">Servicio público</a></li>
                        </ul>
                    </nav>
                </div>   
                </header>
...
<center><main class="table" id="customers_table">
        ...
        <h2>SISTEMA DE ATENCIÓN SIYECA</h2>
  ...
  <form class="d-flex"><!--Formulario para la busqueda a tiempo real-->
      ...
      <hr>
            ...
            <div class="text">
                <a href="fpdf/prueba.php" target="_blank" class="btn btn-success"><i class="fas fa-file-pdf">Generar reporte</i></a>
            </div>
        </section>
